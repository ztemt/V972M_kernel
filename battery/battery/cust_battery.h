...
//xcheng2 modify. when the temperature below 17C,the battery can't be charged, so change pull_up_R 
//#define RBAT_PULL_UP_R             39000
#define RBAT_PULL_UP_R             180000
//xcheng2 modify end
...
#define FAN5405_AC_CHARGING_CURRENT_1050  //charging current definition
#define HIGH_BATTERY_VOLTAGE_SUPPORT //4.35V charging voltage support
